  ...
  render() {
    ...
    return (
      <Modal style={modalStyle}
        ...
        trigger={
            <Button waves='light' className='signup-button' value="Signup" s={6}>Guest Sign Up</Button>
        }>
...
export default connect(mapStateToProps, mapDispatchToProps)(GuestSignupModal);
